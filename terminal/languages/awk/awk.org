...
- 1977
- part of the [[https://pubs.opengroup.org/onlinepubs/9699919799/][POSIX]] standard, mandatory
- by
  - Aho Alfred Vaino (36)
...
- [[https://www.gnu.org/software/gawk/manual/html_node/Feature-History.html][GAWK: A.6 History of gawk Features]] ([[https://fossies.org/linux/gawk/ChangeLog][by date]])
  - 2023 (5.3)
...
- [[https://www.gnu.org/software/gawk/manual/html_node/Variable-Typing.html][GAWK: weakly typed, their type can change as the program runs]]
...
- [[https://www.gnu.org/software/gawk/manual/html_node/Controlling-Array-Traversal.html][GAWK: 12.3.1 Controlling Array Traversal]]
  #+begin_src awk
...
- FPAT [[https://www.gnu.org/software/gawk/manual/html_node/Splitting-By-Content.html][GAWK: 4.7 Defining Fields by Content]]
  - For csv: ~FPAT = "([^,]+)|(\"[^\"]+\")"~
...
| =FIELDWIDTHS= | space separated list of field widths         |     "4 2 2"     |
|---------------+----------------------------------------------+-----------------|
...
|---------------+----------------------------------------------+-----------------|
** built-in functions
[[https://www.gnu.org/software/gawk/manual/html_node/Built_002din.html#Built_002din][GAWK: 9.1 Built-in Functions]]
typeof()
*** TIME
[[https://www.gnu.org/software/gawk/manual/html_node/Time-Functions.html][GAWK: 9.1.6 Time Functions]]
|----------+----------------------+-------------------------------------------------|
|      <r> |                      |                                                 |
...
*** BITWISE
[[https://www.gnu.org/software/gawk/manual/html_node/Bitwise-Functions.html][GAWK: 9.1.7 Bit-Manipulation Functions]]
|--------+-----------+-------------------------------------|
|    <r> |    <c>    |                                     |
|     fn |   args    | returns                             |
|--------+-----------+-------------------------------------|
...
*** MATH
[[https://www.gnu.org/software/gawk/manual/html_node/Numeric-Functions.html][GAWK: 9.1.3 Numeric Functions]]
|-------+-----+------------------------------------|
|   <r> | <c> |                                    |
|    fn | arg | returns                            |
|-------+-----+------------------------------------|
...
|-------+-----+------------------------------------|
*** STRING
[[https://www.gnu.org/software/gawk/manual/html_node/String-Functions.html][GAWK: 9.1.4 String-Manipulation Functions]]
#+begin_src
...
|--------+----------+---------------------------------------------|
*** getline
[[https://www.gnu.org/software/gawk/manual/html_node/Getline.html][GAWK: 4.10 Explicit Input with getline]]
|----------------------+-------------------------------------+---------------------|
...
- [[https://www.gnu.org/software/gawk/manual/html_node/Control-Letters.html][GAWK: 5.5.2 Format-Control Letters]]
- [[https://www.gnu.org/software/gawk/manual/html_node/Format-Modifiers.html][GAWK: 5.5.3 Modifiers for printf Formats]]
- %+-width.prec(?)
...
- @include "ord" OR @load "ordchr"
  - [[https://www.gnu.org/software/gawk/manual/html_node/Extension-Sample-Ord.html][GAWK: 17.7.5 Character and Numeric values: ord() and chr()]]
  - ord(STRING) -> NUMBER
  - chr(NUMBER) -> STRING
...
- [[https://www.gnu.org/software/gawk/manual/html_node/TCP_002fIP-Networking.html][GAWK: 12.5 Using gawk for Network Programming]]
- [[https://www.gnu.org/software/gawk/manual/gawkinet/html_node/index.html][GAWKINET: General Introduction]]
- [[https://www.gnu.org/software/gawk/manual/gawkinet/gawkinet.html#Primitive-Service][GAWKINET: 2.8 A Primitive Web Service]]
...
- [[https://www.gnu.org/software/gawk/manual/html_node/Redirection.html][GAWK: 5.6 Redirecting Output of print and printf]]
- see getline
...
- [[https://www.gnu.org/software/gawk/manual/html_node/Conversion][GAWK: 6.1.4 Conversion of Strings and Numbers]]
...
- sometimes not enforcing variables to be local can cause weird issues.
  ...
  - Example: If I move the if/return0 to the top it works just fine
  - Example: if I make "middle" a local variable
  #+begin_src awk
...
|      svg plot       | [[https://gist.github.com/katef/fb4cb6d47decd8052bd0e8d88c03a102][plot.awk]]                                                |
|         art         | [[https://x.com/climagic/status/1472931718214651912][matrix.awk]]  [[https://gist.github.com/katef/f52978b2ba4583d195414f19342d91ca][hattifatteners.awk]]                          |
|    logs parsing     | https://github.com/kaworu/hawk                          |
...
|      cli utils      | https://github.com/douglasgscofield/tinyutils           |
...
|        libs         | [[https://github.com/e36freak/awk-libs][awk-libs]]  [[https://github.com/dubiousjim/awkenough][awkenough]]                                     |
|---------------------+---------------------------------------------------------|
* snippets
...
[[http://awk.freeshell.org/AwkFeatureComparison.html][Comparisons]] [[https://www.gnu.org/software/gawk/manual/html_node/Other-Versions.html][Others]]

|--------+--------------------------|
|    <r> |           <c>            |
|   gawk |         [[https://www.gnu.org/software/gawk/][home]] [[https://www.gnu.org/software/gawk/manual/html_node/index.html][doc]]         |
|   mawk |           [[https://web.archive.org/web/20240202023335/https://invisible-island.net/mawk/][home]]           |
|  goawk |      [[https://github.com/benhoyt/goawk][benhoyt/goawk]]       |
| bioawk |        [[https://github.com/lh3/bioawk][lh3/bioawk]]        |
|  frawk |      [[https://github.com/ezrosent/frawk][ezrosent/frawk]]      |
|    wak |       [[https://github.com/raygard/wak][raygard/wak]]        |
|   nawk |      [[https://github.com/onetrueawk/awk][onetrueawk/awk]]      |
...
- binary libraries https://gawkextlib.sourceforge.net/
  - pgsql, redis
- editor tools
