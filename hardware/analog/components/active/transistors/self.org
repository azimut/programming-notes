...
- Most can handle up to a few hundred mA in Ice
  - As such it can only handle <700mV in Vbe
...
- transistor leakage
  - this is way dissipators are important on some transistors
  - the way that temperature affects transistors
  - making it unstable and pass more or less electrons

- thermal runaway https://mechatrofice.com/electronics/what-is-thermal-runaway-in-transistor
  - when the transistor leakage is not kept on check
  - it ends up burning
  - a resistor on emitter can help
