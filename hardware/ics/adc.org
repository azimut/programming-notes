...
- uses an OPAMP integration
  - creates an OUTPUT with a =slope= equal to it's INPUT
- measure ammount of time to reach zero

* videos

- 21 [[https://www.youtube.com/watch?v=CQapmDx5oV0][Comparators: The Building Blocks of Analog to Digital Converters (ADC)]]
  - sample&hold, priority encoder
