- https://baylibre.pages.baylibre.com/mediatek/rita/device/mediatek/mtk-android-14/docs/android.html
...
- NOTE: GPT says mainstream kernel support is poor, and in consequence
  - there few ROMS for it
  - the roms that are out there have poor HW performance (eg: incomplete audio drivers or video)
