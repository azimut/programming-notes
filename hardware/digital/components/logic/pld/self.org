...
- project https://github.com/RobertBaruch/22V10-74F269
  - An implementation of the 74F269 bidirectional counter (datasheet) on a 22V10 GAL.
...
- IC:
  ...
  - ATF(16/22)V10/V8 (DIP pin compatible)
    - GAL compatible
    - by MicroChip/Atmel

** article

- GAL16V8 :3- 4 bit counter using macrocell https://estebon.mx/?p=165
...
- [ ] 25 [[https://www.youtube.com/playlist?list=PL0HI91x0gPoE-7veTQ_oNFpNN6CYkrU3M][Programmable Logic Devices (PLDs) mini series]]
  - This mini series covers what are PLDs, using WinCUPL and the CUPL language and programming PLDs such as ATF16V8B, ATV22V10C and ATF750C.
