...
- "Computer Science" is not about computer in the same way that
  ...
  - or biology is not about microscopes, or petri dishes
  - geometry is not about surveying instruments
...
- *Imperative knowledge*: "How to" (a process/the method)
...
- The real issues of CS comes when building large systems (+1000pages)
  - CS uses techniques to handle complexity
    |----------------------------+-------------------------------------------------+------------|
