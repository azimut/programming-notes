...
- [[https://wiki.c2.com/?SamuraiPrinciple][Samurai Principle]] "return victorious or not at all"
  - it takes the burden out from the caller to check for errors
  - aka always return a valid result or no at all
  - aka throw an exception on error
  - aka do not return NULL
  - eg: assert.h
